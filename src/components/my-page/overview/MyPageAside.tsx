...
export default function MyPageAside({
  ...
  return (
    <div className="flex-1 lg:max-w-125">
      <div className="sticky top-30 flex flex-col space-y-4 lg:space-y-8">
        <div className="border-border space-y-3 rounded-2xl border p-4 lg:space-y-4 lg:p-6">
          <h4 className="text-base font-bold">빠른 탐색</h4>
          <ul className="space-y-3">
            <li className="hover:opacity-80">
              <Link href="/my-page/likes" className="flex items-center gap-4">
                <div className="bg-bg-sub flex size-10 items-center justify-center rounded-xl md:size-12">
                  <SpotlightIcon className="text-text-main size-4 md:size-5" />
                </div>
                <div className="flex-1">
                  <h5 className="text-text-sub text-xs leading-normal font-medium md:text-sm">
                    찜한 콘서트
                  </h5>
            ...
            <li className="hover:opacity-80">
              <Link href="/my-page/likes" className="flex items-center gap-4">
                <div className="bg-bg-sub flex size-10 items-center justify-center rounded-xl md:size-12">
                  <MicVocalIcon className="text-text-main size-4 md:size-5" />
                </div>
                <div className="flex-1">
                  <h5 className="text-text-sub text-xs leading-normal font-medium md:text-sm">
                    찜한 아티스트
            ...
            <li className="hover:opacity-80">
              <Link href="/planner" className="flex items-center gap-4">
                <div className="bg-bg-sub flex size-10 items-center justify-center rounded-xl md:size-12">
                  <CalendarCheck className="text-text-main size-4 md:size-5" />
                </div>
                <div className="flex-1">
                  <h5 className="text-text-sub text-xs leading-normal font-medium md:text-sm">
                    참여한 플래너
        ...
        <div className="border-border space-y-3 rounded-2xl border p-4 lg:space-y-4 lg:p-6">
          ...
          {upcomingLikedConcerts.length > 0 ? (
            <ul className="space-y-3">
            ...
            <p className="text-xs leading-normal md:text-base">
              찜한 아티스트의 예정된 콘서트가 없습니다.
            </p>
          ) : (
            <p className="text-xs leading-normal md:text-base">
              아티스트를 찜하고 예정된 콘서트를 한눈에 확인해보세요!
            </p>
          )}
        </div>
      </div>
