  ...
  return (
    <section className="my-10 w-full px-5 md:my-15 lg:my-20 lg:px-15">
      <div className="mx-auto max-w-400">
        <Card className="bg-bg-sub relative overflow-hidden px-6 py-10 md:px-10 md:py-12 xl:bg-[url('/images/bn_planner.webp')] xl:bg-contain xl:bg-right xl:bg-no-repeat xl:px-16 xl:py-20">
          {/* 모바일 배경 이미지 */}
          <div className="absolute top-0 right-0 h-full w-full bg-[url('/images/bn_planner.webp')] bg-contain bg-right bg-no-repeat opacity-20 xl:hidden" />
