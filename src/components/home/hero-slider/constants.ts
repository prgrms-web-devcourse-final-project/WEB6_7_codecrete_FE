...
export const SLIDES = [
  ...
  },
  {
    id: 4,
    title: "뮤지컬\n데스노트",
    description: "최대 01만원 할인 로터리 티켓 OPEN",
    place: "NOL 티켓",
    period: "2025.11.09 - 2026.02.14",
    bgImage: heroSlide04,
    bgColorLeft: "#010101",
    bgColorRight: "#010101",
    darkBg: true,
