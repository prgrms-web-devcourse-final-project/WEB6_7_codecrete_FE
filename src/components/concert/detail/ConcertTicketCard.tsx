...
import { DEFAULT_TICKET_URL, PLACEHOLDER_IMAGE } from "@/components/home/upcoming-slider/constants";
...
function TicketPunch() {
  return (
    <div className="absolute top-[58.8%] left-0 -mt-4 w-full">
      <div className="bg-bg-sub absolute -right-4 h-8 w-8 rounded-full" />
      <div className="bg-bg-sub absolute -left-4 h-8 w-8 rounded-full" />
    </div>
  );
}

function TicketCorners() {
  const cornerClass = "absolute h-8 w-8 rounded-full bg-bg-sub";
